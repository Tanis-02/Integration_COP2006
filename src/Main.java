...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("You have 32 hours, after taking out 8 hours each day for a full rest. "
        + "What would you like to do first: 1. Study, 2. buy supplies, or 3. get to know your teammates?"
        + "Please input a numbered choice.");
    ...
    // in main i created a new card called myCard that has a place to keep the suite and number, i
    // then call it and assign it to the field
